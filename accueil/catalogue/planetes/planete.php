...
<body>
    ...
    <section class="informations">
        <div>
            <ul>
                <li>Demi-grand axe : 57 909 050 km</li>
                <li>Rayon équatorial : 2 439,7 km</li>
                <li>Superficie : 7,48 × 107 km2</li>
                <li>Période de révolution : 87,969 d</li>
                <li>Vitesse de rotation : 10,892 km/h</li>
                <li>Masse : 3,301 1 × 1023 kg</li>
                <li>Satellites connus : 0</li>
        ...
        <div class="desc">
            <div>
                <p>
                    ...
                    numérique, il est précisé aux utilisateurs du site www.solarsys.com l’identité des différents
                    intervenants dans le cadre de sa réalisation et de son suivi :<br />

                    <b>Créateur :</b> Dubroca Nicolas<br />

                    <b>Responsable publication :</b> Dubroca Nicolas – email.email45@email.com<br />

                    Le responsable publication est une personne physique.<br />
                </p>

                <p>
                    <b>CONDITIONS GÉNÉRALES D’UTILISATION DU SITE ET DES SERVICES PROPOSÉS.</b><br />
                    L’utilisation du site www.solarsys.com implique l’acceptation pleine et entière des conditions
                    générales
                    d’utilisation ci-après décrites. Ces conditions d’utilisation sont susceptibles d’être modifiées ou
                    complétées à tout moment, les utilisateurs du site www.solarsys.com sont donc invités à les
                    consulter de
                    manière régulière.<br />

                    Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de
                    maintenance technique peut être toutefois décidée par SOLARSYS, qui s’efforcera alors de communiquer
                    préalablement aux utilisateurs les dates et heures de l’intervention.<br />

                    Le site www.solarsys.com est mis à jour régulièrement par Nicolas DUBROCA. De la même façon, les
                ...
                <p>
                    ...
                    Le site www.solarsys.com a pour objet de fournir une information concernant l’ensemble des activités
                    de
                    la société.<br />

                    SOLARSYS s’efforce de fournir sur le site www.solarsys.com des informations aussi précises que
                    possible.
                    Toutefois, il ne pourra être tenu responsable des omissions, des inexactitudes et des carences dans
                    la
                    mise à jour, qu’elles soient de son fait ou du fait des tiers partenaires qui lui fournissent ces
                    informations.<br />

                    Toutes les informations indiquées sur le site www.solarsys.com sont données à titre indicatif, et
                    sont
                    susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site www.solarsys.com ne
                    sont
                ...
                <p>
                    ...
                    SOLARSYS est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur
                    tous
                ...
                <p>
                    ...
                    SOLARSYS ne pourra être tenue responsable des dommages directs et indirects causés au matériel de
                    l’utilisateur, lors de l’accès au site www.solarsys.com, et résultant soit de l’utilisation d’un
                    ...
                    SOLARSYS ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une
                    perte de marché ou perte d’une chance) consécutifs à l’utilisation du site www.solarsys.com .<br />

                    Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la
                    disposition
                    des utilisateurs. SOLARSYS se réserve le droit de supprimer, sans mise en demeure préalable, tout
                    contenu déposé dans cet espace qui contreviendrait à la législation applicable en France, en
                    particulier
                    aux dispositions relatives à la protection des données. Le cas échéant, SOLARSYS se réserve
                    également la
                ...
                <p>
                    ...
                    À l’occasion de l’utilisation du site www.solarsys.com, peuvent êtres recueillis : l’URL des liens
                    par
                    l’intermédiaire desquels l’utilisateur a accédé au site www.solarsys.com, le fournisseur d’accès de
                    l’utilisateur, l’adresse de protocole Internet (IP) de l’utilisateur.<br />

                    En tout état de cause SOLARSYS ne collecte des informations personnelles relatives à l’utilisateur
                    que
                    pour le besoin de certains services proposés par le site www.solarsys.com. L’utilisateur fournit ces
                    informations en toute connaissance de cause, notamment lorsqu’il procède par lui-même à leur saisie.
                    Il
                    est alors précisé à l’utilisateur du site www.solarsys.com l’obligation ou non de fournir ces
                    informations.<br />
                    ...
                    Aucune information personnelle de l’utilisateur du site www.solarsys.com n’est publiée à l’insu de
                    l’utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule
                    l’hypothèse du rachat de SOLARSYS et de ses droits permettrait la transmission des dites
                    informations à
                    l’éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation et de
                    modification
                    des données vis à vis de l’utilisateur du site www.solarsys.com.<br />
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="services">
            <div class="part_1">
                ...
                <div class="service">
                    ...
                    <nav>
                        <ul>
                            <li><a href="https://www.facebook.com/nicolas.dubroca.927/">Facebook</a></li>
                            <li><a href="https://www.instagram.com/nicolas_dubroca/">Instagram</a></li>
                            <li><a href="https://twitter.com/NicolasDubroca">Twitter</a></li>
    ...
    <p id="contact">&copy; 2022 - SolarSys</p>
