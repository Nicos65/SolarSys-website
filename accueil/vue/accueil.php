<body id="start">
    ...
    <section class="s0" id="ancre_0">
        <div class="btn-section">
            <a href="controller_Page.php?page=news" class="init"><button class="btn-first">Découvrir</button></a>
        </div>
    ...
    <section class="s1" id="ancre_1">
        <div class="btn-section">
            <a href="controller_Page.php?page=Planetes" class="init"><button class="btn-first">Découvrir</button></a>
        </div>
        <div class="section-nav">
    ...
    <section class="s2" id="ancre_2">
        <div class="btn-section">
            <a href="controller_Page.php?page=Satellites"><button class="btn-first">Découvrir</button></a>
        </div>
        <div class="section-nav">
    ...
    <section class="s3" id="ancre_3">
        <div class="btn-section">
            <a href="controller_Page.php?page=Asteroides"><button class="btn-first">Découvrir</button></a>
        </div>
        <div class="section-nav">
    ...
    <section class="s4" id="ancre_4">
        <div class="btn-section">
            <a href="controller_Page.php?page=Contact"><button class="btn-first">Découvrir</button></a>
        </div>
        <div class="section-nav">
